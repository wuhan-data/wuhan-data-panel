...
<!-- 				<span class="text-info">来源</span><input type="text" class="form-control" id="IndiSource" value="" name="Source"> -->
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-default" data-dismiss="modal">关闭
					...
					<button type="submit" class="btn btn-primary" onclick="updatebutton('updateIndiData')">
						提交
					</button>
...
<!-- 				<span class="text-info">时点</span><input type="text" class="form-control" id="addIndiTimePoint" value="" name="addTimePoint"> -->
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-default" data-dismiss="modal">关闭
					...
					<button type="submit" class="btn btn-primary" onclick="addbutton('addIndiData')">
						提交
					</button>
                    ...
                    <form method="post" action="#" id="pageForm">
                        ...
                        <c:if test="${page.currentPage != 1}">
                           ...
                           <a href="#" class='first' onclick="pageClick('1','listIndexManage')">首页</a>
                           <a href="#" class='pre' onclick="pageClick('${page.currentPage-1}','listIndexManage')">上一页</a>
                        </c:if>
                        当前第<span>${page.currentPage}/${page.totalPage}</span>页
                        <c:if test="${page.currentPage != page.totalPage}">
                             <a href="#" class='next' onclick="pageClick('${page.currentPage+1}','listIndexManage')">下一页</a>
                            <a href="#" class='last' onclick="pageClick('${page.totalPage}','listIndexManage')">末页</a>
                        </c:if>
                        跳至&nbsp;

                        <input id="currentPageText" type='text' value='${page.currentPage}' class='allInput w28' name="currentPage" />&nbsp;页&nbsp;
                        <input type="submit" value="GO" class="btn-primary btn-sm" onclick="pageGoClick('listIndexManage')">
                    </form>
                </div>
