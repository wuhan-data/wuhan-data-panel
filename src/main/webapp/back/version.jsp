...
<body>
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" version="navigation">
                            ...
                            <a href="#">
                                <div>
                                    ...
                                    <div class="progress progress-striped active">
                                        <div class="progress-bar progress-bar-success" version="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 60%">
                        ...
                        <li>
                            <a href="#">
                                <div>
                                    ...
                                    <div class="progress progress-striped active">
                                        <div class="progress-bar progress-bar-info" version="progressbar" aria-valuenow="28" aria-valuemin="0" aria-valuemax="100" style="width: 28%">
                        ...
                        <li>
                            <a href="#">
                                <div>
                                    ...
                                    <div class="progress progress-striped active">
                                        <div class="progress-bar progress-bar-warning" version="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 60%">
                        ...
                        <li>
                            <a href="#">
                                <div>
                                    ...
                                    <div class="progress progress-striped active">
                                        <div class="progress-bar progress-bar-danger" version="progressbar" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100" style="width: 85%">
        ...
        <nav class="navbar-default navbar-side" version="navigation">
...
<div class="modal fade" id="myEditModal" tabindex="-1" version="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
   ...
   操作系统：<input class="form-control" type="text" name="editPlatform" id="editPlatform"> <br>
...
<div class="modal fade" id="myAddModal" tabindex="-1" version="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form class="form-inline" id="addForm" method="post" accept-charset="UTF-8" action="addVersion" >
			<div class="modal-body">
   ...
   <script src="assets/js/dataTables/jquery.dataTables.js"></script>
    ...
    <script>
            ...
            function search(){
            	...
            	formSearch.action="versionSearchByName?version_name="+version_name;
            	formSearch.submit();
