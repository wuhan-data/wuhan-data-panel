...
<i class="fa fa-edit"></i>修改
 ...
 --%>
<div class="btn btn-warning btn-sm" style="margin-right:3px" data-toggle="modal" data-target="#myEditModal" onclick="edit('${c.id}',${c.sender_id},'${c.receiver_id}','${c.content}')">
<i class="fa fa-edit"></i>修改
</div>
...
<div class="modal fade" id="myEditModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	...
	<form class="form-inline" id="editForm" method="post" accept-charset="UTF-8" action="editNotice">
			<div class="modal-body">		

	<input class="form-control" type="hidden" name="editNoticeID" id="editNoticeID">
   发送人id：<input class="form-control" type="text" name="editNoticeSender_id" id="editNoticeSender_id">   
   接收人id：<input class="form-control" type="text" name="editNoticeReceiver_id" id="editNoticeReceiver_id"> 
   内容：<input class="form-control" type="text" name="editNoticeContent" id="editNoticeContent">  
			</div>
...
<div class="modal fade" id="myAddModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form class="form-inline" id="addForm" method="post" accept-charset="UTF-8" action="addNotice">
			<div class="modal-body">
				
  <!--    用户id：<input class="form-control" type="search" placeholder="用户id" name="addUserId"> -->
     发送人id：<input class="form-control" type="search" placeholder="发送人id" name="addSender_id">
     接收人id：<input class="form-control" type="search" placeholder="接收人id" name="addReceiver_id"><br>
     内容：<input class="form-control" type="search" placeholder="内容" name="addContent">
...
<div class="modal fade" id="myAddModalByRole" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <!--    用户id：<input class="form-control" type="search" placeholder="用户id" name="addUserId"> -->
     发送人id：<input class="form-control" type="search" placeholder="发送人id" name="addByRoleSender_id">
  ...
  <select class="form-control" id="roleListSelectNotice" name="roleListSelectNotice" onchange="">
     ...
     内容：<input class="form-control" type="search" placeholder="内容" name="addByRoleContent">
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-default" data-dismiss="modal">关闭
				</button>
   ...
   <script src="assets/js/dataTables/jquery.dataTables.js"></script>
    ...
    <script>
         ...
         /*    function add(themename){
            ...
            function edit(ID,sender_id,receiver_id,content){
            	$("#editNoticeID").val(ID);
