...
<c:choose>
  ...
  <!--   <form class="form-inline my-2 my-lg-0" style="float:right" id="formSearch">
     ...
     <form class="form-inline" style="float:right" id="formSearch" method="post" accept-charset="UTF-8">
      <input class="form-control" type="search" placeholder="按uid搜索" aria-label="Search" id="searchtname" value="">
...
<div class="modal fade" id="myEditModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
   ...
   反馈用户id：<input class="form-control" type="text" name="editFeedbackUid" id="editFeedbackUid">  <br>
   反馈标题：<input class="form-control" type="text" name="editFeedbackTitle" id="editFeedbackTitle">  <br>
   正文：<input class="form-control" type="text" name="editFeedbackText" id="editFeedbackText">  <br>
   图片：<input class="form-control" type="text" name="editFeedbackImg" id="editFeedbackImg">  <br>
   联系方式：<input class="form-control" type="text" name="editFeedbackContact" id="editFeedbackContact">  <br>
   反馈时间：<input class="form-control" type="text" name="editFeedbackCreate_time" id="editFeedbackCreate_time">  <br>
   反馈状态：<input class="form-control" type="text" name="editFeedbackState" id="editFeedbackState">   
			</div>
...
<div class="modal fade" id="myLookModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
   ...
   反馈用户id：<input class="form-control" type="text" name="lookFeedbackUid" id="lookFeedbackUid">  <br>
   反馈标题：<input class="form-control" type="text" name="lookFeedbackTitle" id="lookFeedbackTitle">  <br>
   正文：<input class="form-control" type="text" name="lookFeedbackText" id="lookFeedbackText">  <br>
   图片：<input class="form-control" type="text" name="lookFeedbackImg" id="lookFeedbackImg">  <br>
   <%--  <%
   	String array = request.getParameter("arrayImg");
 	String[] arrayImg=array.split(";");
 	
 	for (int i=0;i<arrayImg.length;i++)
 	{
 	out.print(" 图片：<input class=\"form-control\" type=\"text\""+arrayImg[i]);
 	}
%> --%>

   联系方式：<input class="form-control" type="text" name="lookFeedbackContact" id="lookFeedbackContact">  <br>
   反馈时间：<input class="form-control" type="text" name="lookFeedbackCreate_time" id="lookFeedbackCreate_time">  <br>
   反馈状态：<input class="form-control" type="text" name="lookFeedbackState" id="lookFeedbackState">   
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-default" data-dismiss="modal">关闭
				</button>
...
<div class="modal fade" id="myAddModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <!--    用户id：<input class="form-control" type="search" placeholder="用户id" name="addUserId"> -->
     部门代码：<input class="form-control" type="search" placeholder="部门代码" name="addRoleCode" id="addRoleCode" onblur="checkRoleCode()" >
   ...
   <script src="assets/js/dataTables/jquery.dataTables.js"></script>
    ...
    <script>
            ...
            function search(){
            	...
            	formSearch.action="feedbackSearchByUid?uid="+role_name;
            	formSearch.submit();
         ...
         /*    function add(themename){
            ...
            function look(id,uid,title,text,img,contact,state,create_time){
            	...
            	var vote=document.getElementById("chakan");
       			var button=document.getElementById("lookFeedbackContact");
            	var array=img.split(";");
            	var url ="E:\\project\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp0\\wtpwebapps\\wuhan_data1\\feedback\\";
            	...
            	{	
                     ...
                     newspan.src = url+array[i];
            		 //document.getElementById("lookFeedbackImg").appendChild(newspan);
            		 alert(newspan.src);
            		 vote.insertBefore(newspan,button);
