...
<head>
    ...
    <style type="text/css" rel="stylesheet">
        ...
        .page .first, .page .last {
            width: 57px;
            height: 25px;
            background: url(images/page_be.gif) no-repeat;
            line-height: 25px;
            text-indent: -9999px; /* border:1px solid #ccc; */
        }
        ...
        .page .cur {
            ...
            margin-right: 3px;
            line-height: 25px;
            text-align: center; /* border:1px solid #468bbe; */
            color: #468bbe;
        }
            ...
            <div class="row">
                <div class="col-md-12">
                    <h1 class="page-header">
                        栏目管理
                        <div>
                            <small><a href="#" onclick="backFirstMenu('${type_name}')">${type_name}(${ label_name})</a>
                                > <a href="#"
                                     onclick="backSecondMenu('${label_id }','${type_name}','${label_name}','analysisSecondInit')">${theme_name}</a>
                                > <a href="#"
                                     onclick="backThirdMenu('${theme_id }','${label_id }','${type_name}','${label_name }','colPlateInit')">${plate_name }</a>
                            </small>
                        </div>
                    </h1>
                </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="btns col-md-6" id="addElement">
                                <div class="btn btn-info" data-toggle="modal" data-target="#myAddModal" onclick="add()">
                                    <i class="fa fa-plus"></i>添加指标
                                </div>
                                <button class="btn btn-primary" id="reset"
                                        onclick="dosaveSeq('updateIndexWeight','${plate_id}')"><i class="fa fa-cog"></i>保存顺序
                                </button>
                            </div>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <c:forEach items="${indicolumnByPage}" var="c" varStatus="st">
                                        <tr id="${c.indi_id }">
                                            ...
                                            <td>
                                                <div class="search_indi_id">${c.search_indi_id }</div>
                                            </td>
                                            <td>
                                                <div class="indi_old_name">${c.indi_old_name}</div>
                                            </td>
                                            <td>
                                                <div class="indi_new_name">${c.indi_new_name}</div>
                                            </td>
                                            <td width="5%">
                                            ...
                                            <td width="30%">
                                                ...
                                                <div class="btn btn-warning btn-sm" style="margin-right:3px"
                                                     data-toggle="modal"
                                                     data-target="#myEditModal"
                                                     onclick="edit('${c.indi_id}','${c.indi_new_name}','${c.show_color }','${c.show_type }')">
                                                    <i class="fa fa-edit"></i>修改
                                                </div>
                                                <a href="#"
                                                   onclick="delClick('${c.plate_id }','${c.indi_id}','plateIndiDel')">
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                        <c:if test="${c.is_show==0 }">
                                                            <li role="presentation">
                                                                <a href="#" id="noPerShow"
                                                                   onclick="updateShowClick('1','${c.indi_id }','${c.plate_id}','plateIndiUpdateShow')">不展示</a>
                                                            </li>
                                                        </c:if>
                                                        <c:if test="${c.is_show==1 }">
                                                            <li>
                                                                <a href="#" id="perShow"
                                                                   onclick="updateShowClick('0','${c.indi_id }','${c.plate_id}','plateIndiUpdateShow')">展示</a>
                                                            </li>
                                                        </c:if>
                                                    </ul>
                                                </div>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group" id="indi_name_group">
                                                        ...
                                                        <input class="form-control" type="text" placeholder="请输入指标别名"
                                                               id="indi_new_name_edit" name="indi_new_name">
                                                    </div>

                                                    <div class="form-group">
                                                        <label>展示类型</label>
                                                        <select class="form-control" name="show_type" onchange="f1()"
                                                                placeholder="" id="show_type_edit">
                                                    ...
                                                    <div class="form-group">
                                                        <label>展示颜色<input id="chooseColor_edit" type="text" value=""
                                                                          readonly/></label>
                                                        <input id="color_edit" class="form-control" type="text"
                                                               placeholder="请输入展示颜色" name="show_color">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form class="" id="addForm" method="post" accept-charset="UTF-8" action="#">
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        <label>展示颜色<input id="chooseColor" type="text" value=""
                                                                          readonly/></label>
