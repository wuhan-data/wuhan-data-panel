...
<div class="modal fade" id="myEditModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
 ...
 is_read:<select class="form-control" id="editMessageIs_read" name="editMessageIs_read" onchange="">
...
<div class="modal fade" id="myAddModalByRole" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form class="form-inline" id="addForm" method="post" accept-charset="UTF-8" action="addMessageByRole">
			<div class="modal-body">
  ...
  <select class="form-control" id="roleListSelectMessage" name="roleListSelectMessage" onchange="">
    ...
    url：<input class="form-control" type="search" placeholder="内容" name="addByRoleContent"><br>
   ...
   <script src="assets/js/dataTables/jquery.dataTables.js"></script>
    ...
    <script>
            ...
            function editrole(ID,sender_id,receiver_id,url,title,remarks,is_read){
            	...
            	$("#editMessageIs_read").val(is_read)
