...
public class AnalysisServiceImpl implements AnalysisService {
    ...
    public ArrayList<Object> getAnalysisList(int userId) {
        ...
        if(userId == 0) {//未登录用户
            ...
            result = authorityMapper.getAnalysisListByRoleId(default_role_id);
        } else {
            result = authorityMapper.getAnalysisListByUserId(userId);
        }
...
//			System.out.println("themeId" + themeId);
    ...
    public Map<String, Object> initAnalysisPlateByTime(int themeId, String startTime, String endTime, String freqName,
        ...
        String startTimeRadar = endTimeList.get(startTimeList.size()-1).toString();
