...
//	-----------图表数据部分-------------
	//图表1
	public List<indi_TF> getValue1_1(); //图表1的指标数据
	//图表2
	public List<indi_TF> getValue2_1(); //图表2的指标1数据
	public List<indi_TF> getValue2_2(); //图表2的指标2数据
	public List<indi_TF> getValue2_3(); //图表2的指标3数据
	public List<indi_TF> getValue2_4(); //图表2的指标4数据
	//图表3
	public List<indi_TF> getValue3_1(); //图表3的指标1数据---规模以上工业企业资产负债率
	//图表4
	public List<indi_TF> getValue4_1();//图表4的指标1数据---单位GDP建设用地面积
	//图表5
	public List<indi_TF> getValue5_1();//图表5的指标1数据---服务业增加值占地区生产总值比重
	//图表6
...
//	-----------card部分-------------
	...
	//*************topic2-宏观经济************	
//		-----------图表数据部分-------------
		public List<indi_TF> getTopic2Value1_1(); //图表1的指标数据
		public List<indi_TF> getTopic2Value2_1(); //图表2的指标数据--地区生产总值（湖北省）
		public List<indi_TF> getTopic2Value2_2(); //图表2的指标数据--地区生产总值（全国）
		public List<indi_TF> getTopic2Value3_1(); //图表2的指标数据--税收收入占地方一般公共预算收入比重
		public List<indi_TF> getTopic2Value4_1(); //图表2的指标数据--固定资产投资（不含农户）完成额
		public List<indi_TF> getTopic2Value4_2(); //图表2的指标数据--社会消费品零售总额
		public List<indi_TF> getTopic2Value4_3(); //图表2的指标数据--出口总额
