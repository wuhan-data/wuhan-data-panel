...
public class NoticeController {
	...
	@RequestMapping("addNotice")
	 public ModelAndView addNotice(HttpServletRequest request, 
	    	...
	    	notice.setTitle(request.getParameter("addTitle"));
	    	notice.setRemarks(request.getParameter("addRemark"));
	    	notice.setIs_read(0);
	...
	@RequestMapping("addNoticeByRole")
	 public ModelAndView addNoticeByRole(HttpServletRequest request, 
	    	...
	    	String role_name=(request.getParameter("roleListSelectNotice"));
	...
	public ModelAndView editNotice(HttpServletRequest request, 
    	...
    	notice.setCreate_time(new Date());
    	notice.setTitle(request.getParameter("editNoticeTitle"));
    	notice.setRemarks(request.getParameter("editNoticeRemarks"));
    	String is_read=request.getParameter("editNoticeIs_read");
    	notice.setIs_read(Integer.valueOf(is_read));
    	System.out.println("notice edit"+notice.toString()+is_read);
